                            ...
                            <!-- first tab -->
                                    ...
                                    <section>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="titulo" name="titulo" type="text" placeholder="Título"  value="{{{ Input::old('titulo', $preguntas->titulo) }}}" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="ayuda" name="ayuda" type="text" placeholder="ayuda" value="{{{ Input::old('ayuda', $preguntas->ayuda) }}}" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="estilo" name="estilo" type="text" placeholder="estilo"  value="{{{ Input::old('estilo', $preguntas->estilo) }}}" />
                                            </div>
                                        </div>
                                       <p>(*) Obligatorio</p>
